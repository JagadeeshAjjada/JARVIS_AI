...
# In wishMe() function instead of Mr. Jagadeesh you can set your own name


def wishMe():
    hour = int(datetime.datetime.now().hour)
    if hour >= 0 and hour < 12:
        print("Hello Mr. Jagadeesh, Good Morning!")
        speak("Hello Mr. jagadeesh, Good Morning!")

    elif hour >= 12 and hour < 18:
        print("Hello Mr. Jagadeesh, Good Afternoon!")
        speak("Hello Mr. Jagadeesh, Good Afternoon!")

    else:
        print("Hello Mr. Jagadeesh, Good Evening!")
        speak("Hello Mr. Jagadeesh, Good Evening!")
